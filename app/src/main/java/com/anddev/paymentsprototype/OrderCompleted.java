    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OrderCompleted.this,ShowFullDetails.class));
            }
        });
        ...
        borderThick = findViewById(R.id.Stat3View_bgThick);
        borderThin = findViewById(R.id.Stat3View_bgThin);
